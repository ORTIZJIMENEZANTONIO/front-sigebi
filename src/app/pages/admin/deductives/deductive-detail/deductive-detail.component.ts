...
export class DeductiveDetailComponent extends BasePage {

  deductive: any = {};

  constructor(private fb: FormBuilder, protected cd: ChangeDetectorRef, protected router: Router, private service: DeductiveService,
  ...
  ngOnInit(): void {
    ...
    if(this.deductive.id){
      ...
      // this.formDeductive.controls['weightedDeduction'].setValue(this.deductive.weightedDeduction);
      // this.formDeductive.controls['startingRankPercentage'].setValue(this.deductive.startingRankPercentage);
      // this.formDeductive.controls['finalRankPercentage'].setValue(this.deductive.finalRankPercentage);
      // this.formDeductive.controls['contractNumber'].setValue(this.deductive.contractNumber);
      // this.formDeductive.controls['serviceType'].setValue(this.deductive.serviceType);
      // this.formDeductive.controls['version'].setValue(this.deductive.version);
      // this.formDeductive.controls['status'].setValue(this.deductive.status!="NaN"? this.deductive.status:'');
