...
export class GoodSituationListComponent extends BasePage {
  ...
  constructor(
    private service: GoodSituationService,
  ...
  public editRow(event) {
    ...
    const modalRef = this.windowService.open(GoodSituationDetailComponent, { title: `Editar`, context: { data: event.data }, buttons: buttonsConfig }).onClose.subscribe(() => {
  ...
  public openWindow() {
    ...
    const modalRef = this.windowService.open(GoodSituationDetailComponent, { title: `Nuevo`, buttons: buttonsConfig }).onClose.subscribe(() => {
      this.read(this.pageEvent.pageIndex = 0, this.pageEvent.pageSize);
    });
