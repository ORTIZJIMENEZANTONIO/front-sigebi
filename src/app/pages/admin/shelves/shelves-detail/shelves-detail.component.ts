...
@Component({
  selector: 'ngx-shelves-detail',
  templateUrl: './shelves-detail.component.html',
  styleUrls: ['./shelves-detail.component.scss']
})
export class ShelvesDetailComponent extends BasePage {
  ...
  constructor(
    ...
    private questionService: ShelvesService,
