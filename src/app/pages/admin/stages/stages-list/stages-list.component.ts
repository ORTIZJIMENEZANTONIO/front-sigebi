...
export class StagesListComponent extends BasePage {
  ...
  constructor(private service: StageService, public toastrService: NbToastrService,
  ...
  openWindow() {
    const modalRef = this.windowService.open(StagesDetailComponent, { title: `Nuevo` }).onClose.subscribe(() => {
      this.read(this.pageEvent.pageIndex = 0, this.pageEvent.pageSize);
    });
