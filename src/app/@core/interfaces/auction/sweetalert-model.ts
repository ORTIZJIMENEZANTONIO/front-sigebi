...
export class SweetAlertConstants {
    ...
    public static SWEET_ALERT_TITLE_MSG_OK = 'Operacion realizada correctamente...!';
    public static SWEET_ALERT_TITLE_DELETE = 'Eliminar';
    public static SWEET_ALERT_TITLE_MSG_DELETE = 'Esta Seguro de eliminar el elemento seleccionado?';
